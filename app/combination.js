            ...
            <div className="mx-auto grid grid-cols-3 gap-3">
                {[...Array(digits)].map((_, index) =>
                    <input
                        ...
                        placeholder="X"
                        className={`${index === 3 && 'order-last'} ${index === 4 && 'order-5'} ${index === 5 && 'order-4'} border-2 border-gray-400 bg-[#fff] placeholder-gray-400 text-center font-normal w-full py-3 rounded-[10px] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`}
                        key={index}
                    />
                )}
            </div>
            <div className="mt-6 mx-auto grid grid-cols-2">
