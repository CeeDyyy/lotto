...
function OneWin({ fetched, currentName, side, mode, setSumSide = () => { } }) {
    ...
    return (
        <div className="grid grid-cols-2">
            ...
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={win1} onChange={(e) => setWin1(e.target.value)} ref={el => (winRefs.current[1] = el)} onKeyDown={(e) => e.key === "Enter" && winRefs.current[2].focus()} />
            <div className={`w-full text-end border-2 ${check2 ? "bg-green-200" : "bg-white"}`} onClick={()=>setCheck2()}>{info2}</div>
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={win2} onChange={(e) => setWin2(e.target.value)} ref={el => (winRefs.current[2] = el)} onKeyDown={(e) => e.key === "Enter" && winRefs.current[3].focus()} />
            <div className={`w-full text-end border-2 ${check3 ? "bg-green-200" : "bg-white"}`} onClick={()=>setCheck3()}>{info3}</div>
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={win3} onChange={(e) => setWin3(e.target.value)} ref={el => (winRefs.current[3] = el)} onKeyDown={(e) => e.key === "Enter" && winRefs.current[4].focus()} />
            <div className={`w-full text-end border-2 ${check4 ? "bg-green-200" : "bg-white"}`} onClick={()=>setCheck4()}>{info4}</div>
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={win4} onChange={(e) => setWin4(e.target.value)} ref={el => (winRefs.current[4] = el)} onKeyDown={(e) => e.key === "Enter" && winRefs.current[5].focus()} />
            <div className={`w-full text-end border-2 ${check5 ? "bg-green-200" : "bg-white"}`} onClick={()=>setCheck5()}>{info5}</div>
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={win5} onChange={(e) => setWin5(e.target.value)} ref={el => (winRefs.current[5] = el)} onKeyDown={(e) => e.key === "Enter" && winRefs.current[6].focus()} />
            <div className={`w-full text-end border-2 ${check6 ? "bg-green-200" : "bg-white"}`} onClick={()=>setCheck6()}>{info6}</div>
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={win6} onChange={(e) => setWin6(e.target.value)} ref={el => (winRefs.current[6] = el)} onKeyDown={(e) => e.key === "Enter" && winRefs.current[7].focus()} />
            <div className={`w-full text-end border-2 ${check7 ? "bg-green-200" : "bg-white"}`} onClick={()=>setCheck7()}>{info7}</div>
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={win7} onChange={(e) => setWin7(e.target.value)} ref={el => (winRefs.current[7] = el)} onKeyDown={(e) => e.key === "Enter" && winRefs.current[8].focus()} />
            <div className={`w-full text-end border-2 ${check8 ? "bg-green-200" : "bg-white"}`} onClick={()=>setCheck8()}>{info8}</div>
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={win8} onChange={(e) => setWin8(e.target.value)} ref={el => (winRefs.current[8] = el)} onKeyDown={(e) => e.key === "Enter" && winRefs.current[9].focus()} />
            <div className={`w-full text-end border-2 ${check9 ? "bg-green-200" : "bg-white"}`} onClick={()=>setCheck9()}>{info9}</div>
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={win9} onChange={(e) => setWin9(e.target.value)} ref={el => (winRefs.current[9] = el)} onKeyDown={(e) => e.key === "Enter" && winRefs.current[10].focus()} />
            <div className={`w-full text-end border-2 ${check10 ? "bg-green-200" : "bg-white"}`} onClick={()=>setCheck10()}>{info10}</div>
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={win10} onChange={(e) => setWin10(e.target.value)} ref={el => (winRefs.current[10] = el)} onKeyDown={(e) => e.key === "Enter" && winRefs.current[1].focus()} />
