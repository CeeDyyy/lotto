...
function OneUpDown({ fetched, currentName, side, mode, setSumSide = () => { } }) {
    ...
    return (
        <div className="grid grid-cols-3">
            ...
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={info1} onChange={(e) => setInfo1(e.target.value)} ref={el => (infoRefs.current[1] = el)} onKeyDown={(e) => e.key === "Enter" && infoRefs.current[2].focus()} />
            ...
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={info2} onChange={(e) => setInfo2(e.target.value)} ref={el => (infoRefs.current[2] = el)} onKeyDown={(e) => e.key === "Enter" && infoRefs.current[3].focus()} />
            ...
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={info3} onChange={(e) => setInfo3(e.target.value)} ref={el => (infoRefs.current[3] = el)} onKeyDown={(e) => e.key === "Enter" && infoRefs.current[4].focus()} />
            ...
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={info4} onChange={(e) => setInfo4(e.target.value)} ref={el => (infoRefs.current[4] = el)} onKeyDown={(e) => e.key === "Enter" && infoRefs.current[5].focus()} />
            ...
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={info5} onChange={(e) => setInfo5(e.target.value)} ref={el => (infoRefs.current[5] = el)} onKeyDown={(e) => e.key === "Enter" && infoRefs.current[6].focus()} />
            ...
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={info6} onChange={(e) => setInfo6(e.target.value)} ref={el => (infoRefs.current[6] = el)} onKeyDown={(e) => e.key === "Enter" && infoRefs.current[7].focus()} />
            ...
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={info7} onChange={(e) => setInfo7(e.target.value)} ref={el => (infoRefs.current[7] = el)} onKeyDown={(e) => e.key === "Enter" && infoRefs.current[8].focus()} />
            ...
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={info8} onChange={(e) => setInfo8(e.target.value)} ref={el => (infoRefs.current[8] = el)} onKeyDown={(e) => e.key === "Enter" && infoRefs.current[9].focus()} />
            ...
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={info9} onChange={(e) => setInfo9(e.target.value)} ref={el => (infoRefs.current[9] = el)} onKeyDown={(e) => e.key === "Enter" && infoRefs.current[10].focus()} />
            ...
            <input type="number" className="w-full text-end border-2" onClick={(e) => e.target.select()} value={info10} onChange={(e) => setInfo10(e.target.value)} ref={el => (infoRefs.current[10] = el)} onKeyDown={(e) => e.key === "Enter" && infoRefs.current[1].focus()} />
